...
function DefineScreen () {
    ...
    return (
    <div> 
        <h2>Define a Word</h2><br/>
        <div className="mt-2">
                <label><p><b>Share definitions</b> that other people will find meaningful and never post hate speech or people’s personal information.</p></label>
                <textarea
            ...
            <div className="mt-2">
                <label><p><b>Write for a large audience.</b> Lots of people will read this, so give some background information. <br/>
                    <b>Don’t name your friends.</b> We’ll reject inside jokes and definitions naming non-celebrities.</p></label>
                <textarea
                    className="form-control"
                    type="definition"
            ...
            <div className="mt-2">
                <label><p><b>Add the name your definitions will appear under when they are published </b>
                    (Don’t use your real name).</p></label>
                <input
                    className="form-control"
                    type="author"
